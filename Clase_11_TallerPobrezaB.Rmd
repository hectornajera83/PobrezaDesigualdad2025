...
# Confiabilidades
reliability(ajuste_a)
reliability(ajuste_b)
```
...
La **superposición casi exacta** de los coeficientes e intervalos confirma que las escalas construidas con indicadores estadísticamente equivalentes producen estimaciones equivalentes. Esto ilustra el principio de **invariancia estadística bajo intercambiabilidad** en modelos reflectivos.
